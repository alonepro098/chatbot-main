...
from Radhe.modules.helpers import PNG_BTN
...
async def ping(_, message: Message):
    ...
    await loda.edit_caption(
        caption=(
            f"нey вαву!!\n"
            f"{Radhe.name} ιѕ alιve 🥀 αnd worĸιng ғιne wιтн a pιng oғ\n"
            f"➥ `{ms}` ms\n\n"
            f"<b>|| мαdє ωιтн ❣️ ву [RADHE❣️](https://t.me/{OWNER_USERNAME}) ||</b>"
        ),
